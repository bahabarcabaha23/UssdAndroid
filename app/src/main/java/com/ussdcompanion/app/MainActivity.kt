...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<Button>(R.id.btnGrantCallPermission).setOnClickListener {
            ActivityCompat.requestPermissions(
                this,
                arrayOf(android.Manifest.permission.CALL_PHONE, android.Manifest.permission.READ_PHONE_STATE),
                102
            )
        }
    ...
    private fun refreshStatus() {
        ...
        statusCallPermission.text = "إذن الاتصال وتحديد الشريحة: " + if (hasCall && hasPhoneState) "ممنوح ✓" else "غير ممنوح"
